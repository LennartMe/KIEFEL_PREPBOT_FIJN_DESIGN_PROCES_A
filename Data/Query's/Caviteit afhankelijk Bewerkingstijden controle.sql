--Caviteit afhankelijk Bewerkingstijden controle
...
SELECT 
	...
	FORMAT(CAST((ROUND(((TRY_CAST(REPLACE(MachineUrenDummy, ',', '.') AS FLOAT) / TRY_CAST(REPLACE(Cavities_Dummy, ',', '.') AS FLOAT)) * TRY_CAST(REPLACE(Cavities, ',', '.') AS FLOAT)) * 4,0) / 4.0) as decimal(10,3)), 'N2', 'nl-NL')
	...
	--ManUrenDummy,
	--ManUrenDummyRounded,
	FORMAT(CAST((ROUND(((TRY_CAST(REPLACE(ManUrenDummy, ',', '.') AS FLOAT) / TRY_CAST(REPLACE(Cavities_Dummy, ',', '.') AS FLOAT)) * TRY_CAST(REPLACE(Cavities, ',', '.') AS FLOAT)) * 4,0) / 4.0) as decimal(10,3)), 'N2', 'nl-NL')
